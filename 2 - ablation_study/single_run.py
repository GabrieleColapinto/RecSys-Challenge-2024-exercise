...
from transformers.models.ctrl.modeling_ctrl import positional_encoding

from nrms_docvec_ablation import NRMSDocVecAblation
...
with open(parameters_path, "r") as parameters_file:
    ...
    pe = parameters["use_pe"]
    td = parameters["use_td"]
    rln = parameters["use_rln"]
    ...
    model = NRMSDocVecAblation(hparams=hparams, seed=42)
    model.model.compile(
