...
RUNS_DIRECTORY = Path(r"..\experiments\runs-preprocessing")
    ...
    if item.is_dir():
        ...
        with open(config_path, "r") as config_file:
            with open(metrics_path, "r") as metrics_file:
                ...
                # USED MODEL
                premium_propensity = internal_parameter_handle["use_premium_propensity"]
                reading_engagement = internal_parameter_handle["use_reading_engagement"]
                article_length_propensity = internal_parameter_handle["use_article_length_propensity"]

                used_model = None

                match (premium_propensity, reading_engagement, article_length_propensity):
