...
param_grid = {
    ...
    "use_premium_propensity": [True, False],
    "use_reading_engagement": [True, False],
    "use_article_length_propensity": [True, False]
}
...
RUNS_DIR = os.path.join(EXPERIMENTS_DIR, "runs-preprocessing")
